...
<head>
    ...
    <title>GetYourMeal - Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('/dashboard') }}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">GetYourMeal</span>
            </a>
        ...
        <footer class="main-footer">
            <footer>
                <p>&copy; 2025 Tutti i diritti riservati. Realizzato da <a href="https://webdevlab.it"
                        target="_blank">Webdevlab</a>.</p>
            </footer>
        </footer>
