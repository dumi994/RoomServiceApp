<section id="order-confirmation" class="no-bg no-top d-none" style="min-height: 400px;">
    <div class="container">
            ...
            <div class="col-lg-8 text-center">
                <div class="py-5">
                    ...
                    <div class="mt-4">
                        ...
                        <button class="btn btn-outline-secondary ms-2" id="back-to-services">Torna ai servizi</button>
                    </div>
                </div>
            </div>
        </div>
